...
export default function ModalCard({
	...
	return (
		<>
			...
			<div
				role="dialog"
				aria-label={rest.title.toString()}
				className="relative rounded-xl overflow-hidden cursor-pointer group h-80 shadow-2xl border-2 border-gray-500  focus:ring-offset-1 focus:ring-3 focus:ring-blue-600 focus:rounded-xl"
				onClick={() => {
					// setIsHovered(false);
					onClick();
